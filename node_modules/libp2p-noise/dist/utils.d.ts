...
export declare function createHandshakePayload(libp2pPublicKey: bytes, signedPayload: bytes, earlyData?: bytes): Promise<bytes>;
...
export declare function decodePayload(payload: bytes | Uint8Array): Promise<pb.INoiseHandshakePayload>;
